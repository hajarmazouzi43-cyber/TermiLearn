...
<nav style={{
  ...
  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
    <div style={{
      ...
      <span style={{ color: 'white', fontWeight: 800, fontSize: 13, fontFamily: 'monospace' }}>$_</span>
    </div>
    <span style={{ fontWeight: 800, fontSize: 19, color: '#0f172a', letterSpacing: -0.5 }}>TermiLearn</span>
  </div>
  ...
  <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
    ...
    <button onClick={() => onNavigate('course')}
      style={{
        ...
        fontSize: 14, fontWeight: 700, padding: '7px 14px', borderRadius: 8,
  ...
  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
    ...
    <button onClick={() => supabase.auth.signOut()}
      ...
      onMouseEnter={e => { e.currentTarget.style.borderColor = '#fca5a5'; e.currentTarget.style.color = '#ef4444'; e.currentTarget.style.backgroundColor = '#fff5f5' }}
        ...
        {contactSent ? (
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} style={{ textAlign: 'center', padding: '32px 0' }}>
            ...
            <button onClick={() => setContactSent(false)}
              style={{ background: 'none', border: '1.5px solid #10b981', color: '#10b981', fontWeight: 600, cursor: 'pointer', fontSize: 14, padding: '8px 20px', borderRadius: 10 }}
            >Send another →</button>
          </motion.div>
        ) : (
